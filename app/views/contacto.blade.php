...
<section class="icon-contacto">
	<ul>
		...
		<li><div id="borde-blanco"><img src="../assets/facebook.png"><link rel="stylesheet" type="text/css" href="http://www.facebook.com/chariotmx ">Facebook<span>55-3197-4069</span></div></li>
